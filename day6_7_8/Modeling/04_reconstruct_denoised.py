...
def main() -> None:
    ...
    parser.add_argument(
        "--input", default="data/denoised_pixels.hex",
        help="C output hex file (default: data/denoised_pixels.hex)"
    )
    parser.add_argument(
        "--output", default="data/denoised.png",
        help="Visible output image (default: data/denoised.png)"
    )
