...
def main() -> None:
    ...
    parser.add_argument(
        "--input", default="data/rtl_tiling_denoised_pixels.hex",
        help="C output hex file (default: data/rtl_tiling_denoised_pixels.hex)"
    )
    parser.add_argument(
        "--output", default="data/denoised_rtl.png",
        help="Visible output image (default: data/denoised_rtl.png)"
    )
