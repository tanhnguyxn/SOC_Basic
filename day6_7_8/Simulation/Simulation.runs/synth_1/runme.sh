...
HD_PWD='C:/SOC_basic/day6_7_8/Simulation/Simulation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Median_Filter_Core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Median_Filter_Core.tcl
