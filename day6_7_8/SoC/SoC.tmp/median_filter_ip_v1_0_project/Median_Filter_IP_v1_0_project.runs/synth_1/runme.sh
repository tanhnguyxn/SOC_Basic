...
HD_PWD='c:/soc_basic/day6_7_8/soc/soc.tmp/median_filter_ip_v1_0_project/Median_Filter_IP_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Median_Filter_IP_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Median_Filter_IP_v1_0.tcl
