...
HD_PWD='C:/SOC_basic/buoi2/ip_repo/edit_H_Acceleration_IP_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log H_Acceleration_IP_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source H_Acceleration_IP_v1_0.tcl
