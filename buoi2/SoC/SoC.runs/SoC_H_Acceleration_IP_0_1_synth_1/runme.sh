...
HD_PWD='C:/SOC_basic/buoi2/SoC/SoC.runs/SoC_H_Acceleration_IP_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_H_Acceleration_IP_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoC_H_Acceleration_IP_0_1.tcl
