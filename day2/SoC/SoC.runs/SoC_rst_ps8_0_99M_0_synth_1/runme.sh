...
HD_PWD='C:/SOC_basic/buoi2/SoC/SoC.runs/SoC_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoC_rst_ps8_0_99M_0.tcl
