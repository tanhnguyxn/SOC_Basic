...
HD_PWD='C:/SOC_basic/buoi2/SoC/SoC.runs/SoC_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SoC_zynq_ultra_ps_e_0_0.tcl
